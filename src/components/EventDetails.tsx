  ...
  return (
    <section id="details" className="relative z-10 overflow-hidden py-20">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-1/4 w-72 h-72 bg-gradient-to-br from-cyan-400/5 to-purple-400/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-40 right-1/3 w-96 h-96 bg-gradient-to-tl from-red-400/5 to-pink-400/5 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-10 w-64 h-64 bg-gradient-to-r from-green-400/5 to-cyan-400/5 rounded-full blur-3xl"></div>
      </div>
              ...
              <div className="lg:col-span-7 lg:col-start-2">
                <div className="relative">
                  <h2 className="text-6xl sm:text-7xl font-black mb-6 leading-none">
                    ...
                    <span className="block cyber-text-glow text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 transform rotate-1 -mt-4">
                      DEEPER
                    </span>
                  </h2>
                  <div className="absolute -top-8 -right-12 w-24 h-24 border-2 border-cyan-400/30 rounded-full animate-pulse"></div>
                </div>
              </div>
              <div className="lg:col-span-3">
                <div className="cyber-card p-6 bg-gradient-to-br from-gray-800/60 to-gray-900/80 border border-purple-400/30 rounded-2xl backdrop-blur-sm transform rotate-3 hover:rotate-0 transition-all duration-700">
                  <div className="text-center">
                    <Award className="w-8 h-8 text-purple-400 mx-auto mb-3" />
                    <div className="text-2xl font-bold text-white">₹50,000</div>
                    <div className="text-sm text-purple-400">Total Prizes</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative mb-32">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <div 
                  key={index}
                  className={`cyber-card p-8 bg-gradient-to-br from-gray-800/50 to-gray-900/70 border border-cyan-400/30 rounded-2xl backdrop-blur-sm hover:border-cyan-400/60 transition-all duration-500 transform hover:scale-110 ${
